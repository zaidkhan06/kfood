            ...
            <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8 mb-4'>
                ...
                {step == 1
                    ...
                    <div>
                        ...
                        <button onClick={handleSendOtp}  className='w-full mt-2 flex items-center justify-center gap-2  rounded-lg px-4 py-2 transition duration-200 bg-[#ff4d2d] hover:bg-[#e64323] text-white cursor-pointer'>
                            Send Otp
                        </button>
                ...
                {step == 2
                    ...
                    <div>
                        ...
                        <button onClick={handleVerifyOtp}  className='w-full mt-2 flex items-center justify-center gap-2  rounded-lg px-4 py-2 transition duration-200 bg-[#ff4d2d] hover:bg-[#e64323] text-white cursor-pointer'>
                            Verify
                        </button>
                         <p className='text-red-500 text-center'>{error}</p>
                    </div>
                ...
                {step == 3
                    ...
                    <div>
                        ...
                        <button onClick={handleResetPassword}  className='w-full mt-2 flex items-center justify-center gap-2  rounded-lg px-4 py-2 transition duration-200 bg-[#ff4d2d] hover:bg-[#e64323] text-white cursor-pointer'>
                            Reset password
                        </button>
                         <p className='text-red-500 text-center'>{error}</p>
                    </div>
